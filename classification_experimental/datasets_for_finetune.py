...
from hackashop_datasets.cro_24sata import load_cro_train, load_cro_train2
from hackashop_datasets.est_express import load_est_train, load_est_train2
...
def croest_loaders_test():
    for l in ['cro_train', 'cro_train_large', 'est_train', 'est_train_large']:
